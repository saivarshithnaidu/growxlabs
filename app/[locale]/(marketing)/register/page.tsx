          ...
          {success ? (
            <div className="text-center space-y-6 py-8">
              ...
              <div className="space-y-2">
                <h2 className="text-xl font-black text-[#1A1A1A] tracking-tight">Access Initialized</h2>
                <p className="text-sm text-[#6B7280]">Your partner account has been created. Syncing with authentication services...</p>
              </div>
            </div>
          ) : (
            <form onSubmit={handleRegister} className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-[#6B7280]/60 ml-4">Full Organization Name</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-[#6B7280]/60 ml-4">Authorized Email</label>
                <div className="relative group">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-[#6B7280]/60 ml-4">Secure Password</label>
                <div className="relative group">
              ...
              <p className="text-center text-xs text-[#6B7280] font-bold uppercase tracking-widest">
                ...
                <Link href="/login" className="text-[#355CFF] hover:text-[#254CE0] hover:underline transition-colors">Sign In</Link>
              </p>
            </form>
          )}
