...
export const RestaurantNavbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Track Order', href: '/restaurant/track-order' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <Link href="/restaurant" className="flex items-center gap-2 group">
          ...
          <span className="text-xl font-bold tracking-tight text-white">
            GrowX <span className="text-primary font-medium">Eats</span>
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/restaurant/cart">
            <Button size="sm" variant="outline" className="rounded-full px-6 gap-2 border-white/10 hover:bg-white/5">
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col p-6 gap-4">
              ...
              <Link href="/restaurant/cart" className="pt-2" onClick={() => setMobileMenuOpen(false)}>
