...
export function HotlineConsole() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto mt-16 px-4">
      {/* Outer Console Case */}
      <div 
        className="relative rounded-2xl border border-border bg-card shadow-[0_24px_50px_rgba(0,0,0,0.2)] overflow-hidden transition-all duration-300 hover:border-border/80"
      >
        {/* Top Header */}
        <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-border/80 pb-6 p-6 sm:p-8 text-left animate-fade-in">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="text-[15px] font-bold text-foreground tracking-tight mt-0.5 uppercase font-mono">
        ...
        {showCalendly ? (
          ...
          <div className="relative flex flex-col items-center justify-center p-6 sm:p-8">
            <div className="w-full overflow-hidden rounded-xl border border-border/85 bg-background">
              <iframe 
          ...
          <div className="p-6 sm:p-8">
            <div className="w-full rounded-xl border border-border bg-[#05060A] overflow-hidden flex flex-col font-mono text-[13px] text-white/95 shadow-inner">
              {/* Terminal Title Bar */}
              ...
              <div className="p-4 sm:p-5 h-[230px] overflow-y-auto text-left leading-relaxed">
                {activeTab === "logs" && (
        ...
        <div className="pb-6 flex items-center justify-center gap-1.5 text-[11px] text-muted-foreground font-mono font-semibold">
